...
// Totales mensuales
$lecheFijo     = obtenerTotalesMensuales($pdo, 'milk_production', 'production_date', 'quantity_liters', $anioFijo);
$lecheComparar = obtenerTotalesMensuales($pdo, 'milk_production', 'production_date', 'quantity_liters', $anioComparar);

$carneFijo     = obtenerTotalesMensuales($pdo, 'slaughter_records', 'slaughter_date', 'quantity', $anioFijo);
$carneComparar = obtenerTotalesMensuales($pdo, 'slaughter_records', 'slaughter_date', 'quantity', $anioComparar);
$desgloseCarneFijo = obtenerDesgloseSacrificios($pdo, $anioFijo);

$huevosFijo     = obtenerTotalesMensuales($pdo, 'egg_production', 'production_date', 'quantity', $anioFijo);
$huevosComparar = obtenerTotalesMensuales($pdo, 'egg_production', 'production_date', 'quantity', $anioComparar);
