...
// API: Obtener razas por tipo de animal
...
// API: Obtener próximo código según género
...
// API: Agregar nuevo tipo de animal
...
// API: Agregar nueva facilidad (establo, corral, etc.)
...
// ----------------------------------------------
$view   = $_GET['view'] ?? null;   // Detalle de animal
$editId = $_GET['edit'] ?? null;   // Edición de animal

$tiposAnimal = obtenerTiposAnimal($pdo);
$facilidades = obtenerFacilidades($pdo);  // para el select en la vista
...
// --- Vista principal (listado con paginación) ---
$limit = 14;
...
// Datos adicionales para la vista principal
