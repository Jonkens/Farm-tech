<?php
// herramientas/partos/procesos/guardar_evento.php
...
if ($animalId <= 0 || empty($tipo) || empty($fecha)) {
    header('Location: ../index.php?pagina=registrar-evento&error=1');
    exit;
}

guardarEvento($animalId, $tipo, $fecha, $padreId, $notas);
header('Location: ../index.php?pagina=registrar-evento&exito=1');
exit;