...
$lecheFija      = obtenerTotalesSemanales($pdo, 'produccion_leche', 'production_date', 'quantity_liters', $semanaFijaStart);
$lecheComparar  = obtenerTotalesSemanales($pdo, 'produccion_leche', 'production_date', 'quantity_liters', $semanaCompararStart);

$carneFija      = obtenerTotalesSemanales($pdo, 'registros_sacrificio', 'slaughter_date', 'quantity', $semanaFijaStart);
$carneComparar  = obtenerTotalesSemanales($pdo, 'registros_sacrificio', 'slaughter_date', 'quantity', $semanaCompararStart);

$huevosFija     = obtenerTotalesSemanales($pdo, 'produccion_huevos', 'production_date', 'quantity', $semanaFijaStart);
$huevosComparar = obtenerTotalesSemanales($pdo, 'produccion_huevos', 'production_date', 'quantity', $semanaCompararStart);
